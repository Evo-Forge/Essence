...
var DialogContent = (function (_React$Component) {
  ...
  function DialogContent(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DialogContent).call(this, props));

    _this.state = {
      classes: (0, _classnames2.default)('e-dialogs-content', _this.props.classes, _this.props.className)
    };
    return _this;
  }
